...
namespace PortfolioApp.Api.Controllers
{
    ...
    public class FlexesController : ControllerBase
    {
        ...
        public FlexesController(IMediator mediator)
        {
            _mediator = mediator;
        }
        ...
        [HttpPost]
        [Authorize(AuthenticationSchemes = "Admin")]
        public async Task<IActionResult> Post([FromBody] CreateFlexCommandRequest createFlexCommandRequest)
        {
            CommonResponse<bool> response = await _mediator.Send(createFlexCommandRequest);
            return Ok(response);
        }
